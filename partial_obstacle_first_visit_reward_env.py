...
class PartialObstacleFirstVisitRewardEnv(gym.Env):
    """
    Observation
    -----------
    1. 밝혀진 9x9 지도             : 81
    ...
    def __init__(self):
        ...
        # 모든 Observation을 0~1 근처 범위로 정규화한다.
        #
        # discovered map:
        #   -1 = unknown
        #    0 = free
    ...
    def _get_observation(self):
        ...
        # 5. 직전 Action
        previous_action = (
            self._get_previous_action_one_hot()
        )
...
if __name__ == "__main__":
    ...
    env = (
        PartialObstacleFirstVisitRewardEnv()
    )
